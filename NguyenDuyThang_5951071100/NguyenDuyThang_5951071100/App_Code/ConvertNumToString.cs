...
public class ConvertNumToString : System.Web.Services.WebService
{
    ...
    {
        string[] Ones = {"Một", "Hai", "Ba", "Bốn", "Năm", "Sáu", "Bảy", "Tám",
        ...
        if(Number > 999 && Number < 10000) // Nghìn
        {
            int i = (Number / 1000);
